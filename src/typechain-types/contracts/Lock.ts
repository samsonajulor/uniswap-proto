...
export interface LockInterface extends Interface {
  getFunction(
    nameOrSignature: "getBalanceAndTime" | "owner" | "unlockTime" | "withdraw"
  ): FunctionFragment;

  getEvent(nameOrSignatureOrTopic: "Withdrawal"): EventFragment;

  encodeFunctionData(
    functionFragment: "getBalanceAndTime",
    values?: undefined
  ): string;
...
export interface Lock extends BaseContract {
  ...
  getBalanceAndTime: TypedContractMethod<[], [[bigint, bigint]], "view">;
  ...
  getFunction(
    nameOrSignature: "getBalanceAndTime"
